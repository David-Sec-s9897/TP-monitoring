...
public class TimeSeries {
    ...
    public boolean compare(TimeSeries next) {
        if (this.getPeriod().getTimeInterval().getEnd() == (next.getPeriod().timeInterval.getStart())) {
            return true;
        } else if (this.getPeriod().getTimeInterval().getEnd().isAfter(next.getPeriod().timeInterval.getStart())) {
            return true;
