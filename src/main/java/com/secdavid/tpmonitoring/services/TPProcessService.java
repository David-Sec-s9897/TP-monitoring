...
public class TPProcessService {
    ...
    public void init(){
        ...
        process.setMasterData(new MasterData("A83", "10YCH-SWISSGRIDZ", "A95", "A16"));
        TpProcess process2 = new TpProcess("17.1.E - Automatic Frequency Restoration Reserve (aFRR)");
        process2.setMasterData(new MasterData("A83", "10YCH-SWISSGRIDZ", "A96", "A16"));
        TpProcess process3 = new TpProcess("17.1.E - Replacement Reserve (RR)");
        process3.setMasterData(new MasterData("A83", "10YCH-SWISSGRIDZ", "A98", "A16"));
